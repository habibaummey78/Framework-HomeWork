...
//Sendkeys method is called
	...
	@Test(enabled = false)
	public void isDisplayed_in_create_account() {
		boolean elementDisplayed = driver
				.findElement(By
						.cssSelector("kds-Button.interactive.palette-accent.kind-prominent.variant-border.w-full my-8"))
				.isDisplayed();/// q,,,,,
		System.out.println("Is the create account displayed? Ans: " + elementDisplayed);
	}
	...
	@Test(enabled = false)
	public void isSelected_in_logo() throws InterruptedException {
		boolean logoSelected = driver.findElement(By.xpath("//img[@class='Image']")).isSelected();
		System.out.println("Is the logo selected? Ans: " + logoSelected);
